...
class Gini():
    """
       Initialisation de la classe Gini,
       'file' est le chemin d'accès au fichier CSV
    """
    ...
    """
        Méthode qui trouve la meilleure division d'un noeud. Elle renvoie la variable, 
        le seuil et le coefficient de gini qui maximisent la pureté des noeuds enfants.
    """
    ...
    """
        Méthode récursive 
        qui construit l'arbre de décision en cherchant 
        la meilleure division pour chaque noeud.
    """
    ...
    """
        Utiliser la librairie Graphviz pour afficher l'arbre de décision
    """
    def display(self):
    ...
    """
        Lancer l'algorithme de Gini puis la construction de l'affichage de l'arbre
    """
    def main(self):
